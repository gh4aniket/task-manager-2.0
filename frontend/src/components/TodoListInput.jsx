  ...
  return (
    <div>
      {todoList.map((item, index) => (
        <div
          key={item}
          className="flex items-center w-100 justify-between bg-slate-900/50 border-gray-100 px-3 py-2 rounded-md mb-3 mt-2"
        >
      ...
      <div className="flex items-center gap-5 mt-4">
        <input
          ...
          className="w-120 text-[13px] text-black outline-none bg-white border border-gray-300 px-3 py-2 rounded-md"
        />
